...
public class LoginViewController {
			...
			throws IOException, NoSuchAlgorithmException, InvalidKeySpecException
	{
		...
		Path filePath = Path.of("src/main/java/testing/unimportant.txt"); //Potentially a problem
		String filePathString = "src/main/java/testing/unimportant.txt"; //Potentially a problem
